...
if (typeof window.ethereum !== 'undefined') {
  ...
  async function getMetMaskAccounts(){
	...
	function displayStats(){
		document.getElementById("staked").innerHTML = "Staked: " + toFixed(statictics[0]/10000000000);
		document.getElementById("rewards").innerHTML = "Rewards: " + toFixed(statictics["rewards"]/10000000000);
	}
	function loadStats(){
